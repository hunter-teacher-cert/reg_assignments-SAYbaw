...
Now you saw before I put \[dollar sign]0 and this time I just used print. Anything after a \$ is a field number and \[dollar sign]0 is all the fields in a line, however, if you omit \$0 AWK will assume you want to print the whole line. To print the second line we just compare NR equality to 2. We can also omit the action statement altogether and AWK will assume we want to print the whole line.
